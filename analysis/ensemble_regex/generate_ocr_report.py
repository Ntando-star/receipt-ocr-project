# analysis/ensemble_regex/generate_ocr_report.py
import json
import os
...
def generate_markdown_report(results_file: str = "evaluation_results_detailed_ensemble.json",
                             stats_file: str = "evaluation_results_statistics_ensemble.json") -> str:
    """Generate a markdown report for ensemble OCR research write-up."""
...
if __name__ == "__main__":
    ...
    # Save report
    with open("OCR_PERFORMANCE_REPORT_ENSEMBLE.md", "w", encoding='utf-8') as f:
        f.write(report)
    
    print("✅ Report saved to OCR_PERFORMANCE_REPORT_ENSEMBLE.md")
    print("\nReport Preview:")
    print(report)
